...
class bathensemble():
    ...
    def simulateSingleBath(self):
        ...
        if self.diffType == 'super':
            omega_min=self.N**(-1.0231)#(-self.c) #gives only the boundary to the prob distr. of frequencies, actual lowest frequency can be bigger
            omega_max=omega_min*self.N**1.2738
