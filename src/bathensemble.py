...
class bathensemble():
    ...
    def simulateSingleBath(self):
        ...
        if self.diffType == 'super':
            omega_min=self.N**(-1.013157894736842)#(-self.c) #gives only the boundary to the prob distr. of frequencies, actual lowest frequency can be bigger
            omega_max=omega_min*self.N**1.268421052631579
