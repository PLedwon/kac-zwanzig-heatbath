...
plt.loglog(timesteps[linindex::8000],linDiff(timesteps[linindex::8000],linpopt[0],linpopt[1]),linestyle=':',label=r'$\propto t$', marker='o')
plt.xlabel('t')
plt.ylabel('Var(Q)')
plt.legend()
...
plt.plot(timesteps[linindex::8000],linDiff(timesteps[linindex::8000],linpopt[0],linpopt[1]),label=r'$\propto t$', linestyle=':',marker='o')
plt.xlabel('t')
plt.ylabel('Var(Q)')
plt.legend()
