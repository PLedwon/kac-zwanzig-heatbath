...
plt.loglog(timesteps[linindex::80000],linDiff(timesteps[linindex::80000],linpopt[0],linpopt[1]),linestyle=':',label=r'$\propto t$')
plt.xlabel('t')
plt.ylabel('Var(Q)')
plt.legend()
...
plt.plot(timesteps[linindex::80000],linDiff(timesteps[linindex::80000],linpopt[0],linpopt[1]),label=r'$\propto t$', linestyle=':')
plt.xlabel('t')
plt.ylabel('Var(Q)')
plt.legend()
