...
var = plt.figure(1)
plt.loglog(timesteps[startindex:endindex],varQ[startindex:endindex],'x',timesteps[startindex:endindex],theoDiff(timesteps,gamma)[startindex:endindex])
...
Kernel = plt.figure(2)
plt.plot(timesteps,memoryKernel(timesteps),timesteps,K,'x')
plt.xlabel('t')
