...
var = plt.figure(1)
plt.loglog(timesteps[startindex:endindex:16000],varQ[startindex:endindex:16000],'x',timesteps[startindex:endindex:16000],theoDiff(timesteps,gamma)[startindex:endindex:16000])
...
Kernel = plt.figure(2)
plt.plot(timesteps[::16000],memoryKernel(timesteps)[::16000],timesteps[::16000],K[::16000],'x')
plt.xlabel('t')
