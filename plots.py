...
var = plt.figure(1)
plt.loglog(timesteps[startindex:endindex],varQ[startindex:endindex],timesteps[startindex:endindex],theoDiff(timesteps,gamma)[startindex:endindex],marker='o')
...
Kernel = plt.figure(2)
plt.plot(timesteps,memoryKernel(timesteps),timesteps,K,marker='o')
plt.xlabel('t')
