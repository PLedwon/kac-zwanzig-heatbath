...
plt.loglog(timesteps[linindex::8000],linDiff(timesteps[linindex::8000],linpopt[0],linpopt[1]),linestyle=':',label='linear Diffusion')
plt.xlabel('t')
plt.ylabel('Var(Q)')
plt.legend()
...
plt.plot(timesteps[linindex::8000],linDiff(timesteps[linindex::8000],linpopt[0],linpopt[1]),label='linear Diffusion', linestyle=':')
plt.xlabel('t')
plt.ylabel('Var(Q)')
plt.legend()
...
Kernel = plt.figure(3)
plt.loglog(timesteps[::1600],K[::1600],label='Bath memory kernel')
plt.loglog(timesteps[::16000],memoryKernel(timesteps)[::16000],label='Theoretical memory kernel', linestyle=':')
plt.xlabel('t')
