...
plt.loglog(timesteps[startindex:endindex:8000],theoDiff(timesteps,1.45,fitindex)[startindex:endindex:8000],label=r'$\propto t^{1.45}$')
plt.loglog(timesteps[startindex:endindex:8000],theoDiff(timesteps,1.55,fitindex)[startindex:endindex:8000],label=r'$\propto t^{1.55}$')
plt.xlabel('t')
plt.ylabel('Var(Q)')
plt.legend()
...
plt.plot(timesteps[startindex:endindex:8000],theoDiff(timesteps,1.45,fitindex)[startindex:endindex:8000],label=r'$\propto t^{1.45}$')
plt.xlabel('t')
plt.ylabel('Var(Q)')
plt.legend()
