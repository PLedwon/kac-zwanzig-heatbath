...
plt.errorbar(timestepsErr, varQ[timeToIndexArray], std, fmt='none')
...
var = plt.figure(2)
plt.plot(timesteps[::8000],varQ[::8000],label='Numerical results',color='#cc0099' )
plt.errorbar(timestepsErr, varQ[timeToIndexArray], std, fmt='none', ecolor='#cc0099')
