...
var = plt.figure(1)
plt.loglog(timesteps[startindex:endindex:160000],varQ[startindex:endindex:160000],'x',timesteps[startindex:endindex:160000],theoDiff(timesteps,gamma)[startindex:endindex:160000])
...
Kernel = plt.figure(2)
plt.plot(timesteps[::160000],memoryKernel(timesteps)[::160000],timesteps[::160000],K[::160000],'x')
plt.xlabel('t')
